...
fn main() {
    ...
    let entry_points = vec![
        ...
        (121, EntryPoints::InitializeVectorPicture { length: 128 }),
        (23, EntryPoints::VectorPicture { length: 128 }),
        (23, EntryPoints::VectorPictureRead { length: 128 }),
        ...
        (16679, EntryPoints::VectorSplitOffAppend {
        ...
        (37460, EntryPoints::VectorSplitOffAppend {
            vec_len: 3000,
            element_len: 1,
            index: 100,
            repeats: 1000,
        }),
        (26035, EntryPoints::VectorSplitOffAppend {
            vec_len: 3000,
            element_len: 1,
            index: 2990,
            repeats: 1000,
        }),
        (35783, EntryPoints::VectorRemoveInsert {
            vec_len: 3000,
            element_len: 1,
            index: 100,
            repeats: 1000,
        }),
        (28175, EntryPoints::VectorRemoveInsert {
            vec_len: 3000,
            element_len: 1,
            index: 2998,
            repeats: 1000,
        }),
        (45304, EntryPoints::VectorRangeMove {
            vec_len: 3000,
            element_len: 1,
            index: 1000,
            move_len: 500,
        ...
        (594, EntryPoints::VectorSplitOffAppend {
            // baseline, only vector creation
            vec_len: 100,
            element_len: 100,
            index: 0,
        ...
        (10017, EntryPoints::VectorSplitOffAppend {
            vec_len: 100,
            element_len: 100,
            index: 10,
            repeats: 1000,
        }),
        (5513, EntryPoints::VectorRangeMove {
            vec_len: 100,
            element_len: 100,
            index: 50,
            move_len: 10,
