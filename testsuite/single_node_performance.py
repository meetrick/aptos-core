...
TESTS = [
    ...
    RunGroupConfig(expected_tps=100, key=RunGroupKey("vector-split-off-append-len3000-size1"), included_in=Flow.CONTINUOUS, waived=True),
    RunGroupConfig(expected_tps=100, key=RunGroupKey("vector-remove-insert-len3000-size1"), included_in=Flow.CONTINUOUS, waived=True),
